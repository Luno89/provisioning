...
import { buildGameContainerPorts, createGameServerService } from "../lib/game-server-ports.js";
/**
 ...
 */
const SECRET_ENVS = ["ADMIN_PASSWORD", "SERVER_PASSWORD", "RCON_PASSWORD"];
                        ...
                        container: [
                            {
                                ...
                                env: [
                                    ...Object.entries(settings)
                                        ...
                                        .filter(([name]) => !SECRET_ENVS.includes(name))
