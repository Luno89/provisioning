...
export declare function releasePostrenderToHclTerraform(struct?: ReleasePostrenderOutputReference | ReleasePostrender): any;
...
export declare function releaseSetToHclTerraform(struct?: ReleaseSet | cdktf.IResolvable): any;
...
export declare function releaseSetListStructToTerraform(struct?: ReleaseSetListStruct | cdktf.IResolvable): any;
export declare function releaseSetListStructToHclTerraform(struct?: ReleaseSetListStruct | cdktf.IResolvable): any;
export declare class ReleaseSetListStructOutputReference extends cdktf.ComplexObject {
    private isEmptyObject;
    private resolvableValue?;
    /**
    * @param terraformResource The parent resource
    ...
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean);
    get internalValue(): ReleaseSetListStruct | cdktf.IResolvable | undefined;
    set internalValue(value: ReleaseSetListStruct | cdktf.IResolvable | undefined);
    private _name?;
    get name(): string;
    set name(value: string);
    get nameInput(): string | undefined;
...
export declare class ReleaseSetListStructList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    internalValue?: ReleaseSetListStruct[] | cdktf.IResolvable;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    * @param wrapsSet whether the list is wrapping a set (will add tolist() to be able to access an item via an index)
...
export declare function releaseSetSensitiveToHclTerraform(struct?: ReleaseSetSensitive | cdktf.IResolvable): any;
...
export declare class Release extends cdktf.TerraformResource {
    ...
    */
    ...
    get upgradeInstall(): boolean | cdktf.IResolvable;
    set upgradeInstall(value: boolean | cdktf.IResolvable);
    resetUpgradeInstall(): void;
    get upgradeInstallInput(): boolean | cdktf.IResolvable | undefined;
    private _values?;
    get values(): string[];
    ...
    putSetList(value: ReleaseSetListStruct[] | cdktf.IResolvable): void;
    resetSetList(): void;
    get setListInput(): cdktf.IResolvable | ReleaseSetListStruct[] | undefined;
