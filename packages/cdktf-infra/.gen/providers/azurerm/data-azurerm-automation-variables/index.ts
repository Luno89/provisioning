// https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/automation_variables
...
export interface DataAzurermAutomationVariablesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/automation_variables#automation_account_id DataAzurermAutomationVariables#automation_account_id}
  */
  readonly automationAccountId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/automation_variables#id DataAzurermAutomationVariables#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/automation_variables#timeouts DataAzurermAutomationVariables#timeouts}
  */
...
export class DataAzurermAutomationVariablesBoolOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermAutomationVariablesBool | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermAutomationVariablesBool | undefined) {
    if (value === undefined) {
...
export class DataAzurermAutomationVariablesBoolList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAzurermAutomationVariablesBoolOutputReference {
    return new DataAzurermAutomationVariablesBoolOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAzurermAutomationVariablesDatetimeOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermAutomationVariablesDatetime | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermAutomationVariablesDatetime | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAzurermAutomationVariablesDatetimeList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAzurermAutomationVariablesDatetimeOutputReference {
    return new DataAzurermAutomationVariablesDatetimeOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAzurermAutomationVariablesEncryptedOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermAutomationVariablesEncrypted | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermAutomationVariablesEncrypted | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAzurermAutomationVariablesEncryptedList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAzurermAutomationVariablesEncryptedOutputReference {
    return new DataAzurermAutomationVariablesEncryptedOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAzurermAutomationVariablesIntOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermAutomationVariablesInt | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermAutomationVariablesInt | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAzurermAutomationVariablesIntList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAzurermAutomationVariablesIntOutputReference {
    return new DataAzurermAutomationVariablesIntOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAzurermAutomationVariablesNullOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermAutomationVariablesNull | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermAutomationVariablesNull | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAzurermAutomationVariablesNullList extends cdktf.ComplexList {
...
export class DataAzurermAutomationVariablesStringOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermAutomationVariablesString | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermAutomationVariablesString | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAzurermAutomationVariablesStringList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAzurermAutomationVariablesStringOutputReference {
    return new DataAzurermAutomationVariablesStringOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataAzurermAutomationVariablesTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/automation_variables#read DataAzurermAutomationVariables#read}
  */
  readonly read?: string;
}

export function dataAzurermAutomationVariablesTimeoutsToTerraform(struct?: DataAzurermAutomationVariablesTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAzurermAutomationVariablesTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermAutomationVariablesTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermAutomationVariablesTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/automation_variables azurerm_automation_variables}
*/
export class DataAzurermAutomationVariables extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_automation_variables";
  ...
  * @param importFromId The id of the existing DataAzurermAutomationVariables that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/automation_variables#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_automation_variables", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/automation_variables azurerm_automation_variables} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAzurermAutomationVariablesConfig
  */
  public constructor(scope: Construct, id: string, config: DataAzurermAutomationVariablesConfig) {
    super(scope, id, {
  ...
  // bool - computed: true, optional: false, required: false
  private _bool = new DataAzurermAutomationVariablesBoolList(this, "bool", false);
  public get bool() {
    return this._bool;
  }

  // datetime - computed: true, optional: false, required: false
  private _datetime = new DataAzurermAutomationVariablesDatetimeList(this, "datetime", false);
  public get datetime() {
    return this._datetime;
  }

  // encrypted - computed: true, optional: false, required: false
  private _encrypted = new DataAzurermAutomationVariablesEncryptedList(this, "encrypted", false);
  public get encrypted() {
  ...
  // int - computed: true, optional: false, required: false
  private _int = new DataAzurermAutomationVariablesIntList(this, "int", false);
  public get int() {
    return this._int;
  }

  // null - computed: true, optional: false, required: false
  ...
  private _string = new DataAzurermAutomationVariablesStringList(this, "string", false);
  public get string() {
    return this._string;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts = new DataAzurermAutomationVariablesTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurermAutomationVariablesTimeouts) {
