...
export * as storageAccountQueueProperties from './storage-account-queue-properties';
export * as storageAccountStaticWebsite from './storage-account-static-website';
