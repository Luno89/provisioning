// https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/eventgrid_domain
...
export interface DataAzurermEventgridDomainConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/eventgrid_domain#id DataAzurermEventgridDomain#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/eventgrid_domain#name DataAzurermEventgridDomain#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/eventgrid_domain#resource_group_name DataAzurermEventgridDomain#resource_group_name}
  */
  readonly resourceGroupName: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/eventgrid_domain#timeouts DataAzurermEventgridDomain#timeouts}
  */
...
export class DataAzurermEventgridDomainIdentityOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermEventgridDomainIdentity | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermEventgridDomainIdentity | undefined) {
    if (value === undefined) {
...
export class DataAzurermEventgridDomainIdentityList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAzurermEventgridDomainIdentityOutputReference {
    return new DataAzurermEventgridDomainIdentityOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export interface DataAzurermEventgridDomainTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/eventgrid_domain#read DataAzurermEventgridDomain#read}
  */
  readonly read?: string;
}

export function dataAzurermEventgridDomainTimeoutsToTerraform(struct?: DataAzurermEventgridDomainTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataAzurermEventgridDomainTimeoutsToHclTerraform(struct?: DataAzurermEventgridDomainTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/eventgrid_domain azurerm_eventgrid_domain}
*/
export class DataAzurermEventgridDomain extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermEventgridDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/eventgrid_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/data-sources/eventgrid_domain azurerm_eventgrid_domain} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _identity = new DataAzurermEventgridDomainIdentityList(this, "identity", false);
  public get identity() {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: dataAzurermEventgridDomainTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataAzurermEventgridDomainTimeouts",
      },
    };
