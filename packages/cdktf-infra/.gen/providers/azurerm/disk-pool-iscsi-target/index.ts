// https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/resources/disk_pool_iscsi_target
...
export interface DiskPoolIscsiTargetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/resources/disk_pool_iscsi_target#acl_mode DiskPoolIscsiTarget#acl_mode}
  */
  readonly aclMode: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/resources/disk_pool_iscsi_target#disks_pool_id DiskPoolIscsiTarget#disks_pool_id}
  */
  readonly disksPoolId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/resources/disk_pool_iscsi_target#id DiskPoolIscsiTarget#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/resources/disk_pool_iscsi_target#name DiskPoolIscsiTarget#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/resources/disk_pool_iscsi_target#target_iqn DiskPoolIscsiTarget#target_iqn}
  */
  readonly targetIqn?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/resources/disk_pool_iscsi_target#timeouts DiskPoolIscsiTarget#timeouts}
  */
  readonly timeouts?: DiskPoolIscsiTargetTimeouts;
}
export interface DiskPoolIscsiTargetTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/resources/disk_pool_iscsi_target#create DiskPoolIscsiTarget#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/resources/disk_pool_iscsi_target#delete DiskPoolIscsiTarget#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/resources/disk_pool_iscsi_target#read DiskPoolIscsiTarget#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/resources/disk_pool_iscsi_target azurerm_disk_pool_iscsi_target}
*/
export class DiskPoolIscsiTarget extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DiskPoolIscsiTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/resources/disk_pool_iscsi_target#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.117.1/docs/resources/disk_pool_iscsi_target azurerm_disk_pool_iscsi_target} Resource
  *
  * @param scope The scope in which to define this construct
