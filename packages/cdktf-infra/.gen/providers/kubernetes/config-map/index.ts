// https://registry.terraform.io/providers/hashicorp/kubernetes/2.38.0/docs/resources/config_map
...
export function configMapMetadataToTerraform(struct?: ConfigMapMetadataOutputReference | ConfigMapMetadata): any {
...
export class ConfigMapMetadataOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ConfigMapMetadata | undefined {
  ...
  public set internalValue(value: ConfigMapMetadata | undefined) {
    if (value === undefined) {
...
export class ConfigMap extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the ConfigMap to import
  * @param importFromId The id of the existing ConfigMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.38.0/docs/resources/config_map#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _metadata = new ConfigMapMetadataOutputReference(this, "metadata");
  public get metadata() {
