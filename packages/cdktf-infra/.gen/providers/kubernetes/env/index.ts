// https://registry.terraform.io/providers/hashicorp/kubernetes/2.38.0/docs/resources/env
...
export class EnvEnvValueFromConfigMapKeyRefOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EnvEnvValueFromConfigMapKeyRef | undefined {
  ...
  public set internalValue(value: EnvEnvValueFromConfigMapKeyRef | undefined) {
    if (value === undefined) {
...
export class EnvEnvValueFromFieldRefOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EnvEnvValueFromFieldRef | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: EnvEnvValueFromFieldRef | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class EnvEnvValueFromResourceFieldRefOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EnvEnvValueFromResourceFieldRef | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: EnvEnvValueFromResourceFieldRef | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class EnvEnvValueFromSecretKeyRefOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EnvEnvValueFromSecretKeyRef | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._key !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: EnvEnvValueFromSecretKeyRef | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._key = undefined;
      this._name = undefined;
...
export class EnvEnvValueFromOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EnvEnvValueFrom | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: EnvEnvValueFrom | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  public putConfigMapKeyRef(value: EnvEnvValueFromConfigMapKeyRef) {
  ...
  public putFieldRef(value: EnvEnvValueFromFieldRef) {
  ...
  public putResourceFieldRef(value: EnvEnvValueFromResourceFieldRef) {
  ...
  public putSecretKeyRef(value: EnvEnvValueFromSecretKeyRef) {
...
export class EnvEnvOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: EnvEnv | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  public putValueFrom(value: EnvEnvValueFrom) {
...
export class EnvMetadataOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EnvMetadata | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._name !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: EnvMetadata | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._name = undefined;
...
export class Env extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Env that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.38.0/docs/resources/env#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Env to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "kubernetes_env", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: EnvConfig) {
    ...
    this._id = config.id;
    this._initContainer = config.initContainer;
  ...
  public putEnv(value: EnvEnv[] | cdktf.IResolvable) {
  ...
  public putMetadata(value: EnvMetadata) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      init_container: cdktf.stringToTerraform(this._initContainer),
      kind: cdktf.stringToTerraform(this._kind),
      env: cdktf.listMapper(envEnvToTerraform, true)(this._env.internalValue),
