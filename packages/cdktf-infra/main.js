...
function initK8sProvider(scope, config) {
    ...
    constructor(scope, id) {
        ...
        if (process.env.APP_SETTINGS_JSON) {
            try {
                ...
                throw new Error(`APP_SETTINGS_JSON is not valid JSON: ${err.message}`);
            }
        }
        ...
        if (process.env.APP_SPEC_JSON) {
            ...
            try {
                ...
                throw new Error(`APP_SPEC_JSON is not valid JSON: ${err.message}`);
            }
        ...
        if (strategy === 'native') {
            if (appType === 'wordpress') {
                ...
                new VllmApp(this, "vllm-app", {
                    ...
                    gpuVendor: process.env.VLLM_GPU_VENDOR || 'nvidia',
