...
const OWNS: Record<string, readonly ToolNeed[]> = {
  ...
  get_tree_type: [],
  create_tree_type: [],
  set_tree_type_overview: [],
  set_tree_type_scaffold_file: [],
  delete_tree_type_scaffold_file: [],
  add_validation_step: [],
  add_validation_group: [],
  add_validation_loop: [],
  revise_validation_step: [],
  remove_validation_step: [],
  reorder_validation_steps: [],
  set_tree_type_bindings: [],
  set_tree_type_roles: [],
  set_tree_type_auto_accept: [],
  set_tree_type_verdict_policy: [],
  delete_tree_type: [],
  add_workflow_stage: [],
  add_workflow_group: [],
  add_workflow_loop: [],
  revise_workflow_stage: [],
  remove_workflow_stage: [],
  reorder_workflow_stages: [],
  get_project_pipeline: [],
  get_project_url: [],
  read_project_path: ['projects'],
  get_project_env: [],
  set_project_env: [],
  web_search: ['web'],
  fetch_web_page: ['web'],
