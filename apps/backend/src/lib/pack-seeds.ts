...
export const PACK_SEEDS: PackSeed[] = [
  {
    ...
    tools: [
      ...
      'get_tree_type', 'create_tree_type', 'set_tree_type_overview',
      'set_tree_type_scaffold_file', 'delete_tree_type_scaffold_file',
      ...
      'set_tree_type_bindings', 'set_tree_type_roles', 'set_tree_type_auto_accept', 'set_tree_type_verdict_policy', 'delete_tree_type',
  ...
  },
  {
    ...
    tools: [
      ...
      'write_plan_document', 'research', 'read_project_path',
    ],
